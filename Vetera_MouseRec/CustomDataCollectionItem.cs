...
#pragma warning restore CS0114 // 'CustomDataCollectionItem.Text' hides inherited member 'UserControl.Text'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        ...
        private void SetColor()
        {
            ...
            text_title.BackColor = Storage.colorBackgrund[Storage.themePointer];
            text_title.ForeColor = Storage.colorText[Storage.themePointer];

            //toolTip.BackColor = Cash.color_item_backgrund[Cash.theame];
            //toolTip.ForeColor = Cash.color_text[Cash.theame];

            Text_playbackOrder.BackColor = Storage.colorBackgrund[Storage.themePointer];
            Text_playbackOrder.TextColor = Storage.colorText[Storage.themePointer];
            ...
            pictureBox_DropDown.BackColor = Storage.colorBackgrund[Storage.themePointer];
            pictureBox_DropDown.Image = Storage.ArrwoDown;

            button_up.BackColor = Storage.colorBackgrund[Storage.themePointer];
            button_up.Image = Storage.AUp;

            button_down.BackColor = Storage.colorBackgrund[Storage.themePointer];
            button_down.Image = Storage.ADown;

            button_options.BackColor = Storage.colorBackgrund[Storage.themePointer];
            button_options.Image = Storage.Options;
