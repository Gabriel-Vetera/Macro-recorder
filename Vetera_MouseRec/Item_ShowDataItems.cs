...
namespace Vetera_MouseRec
{
    public partial class Item_ShowDataItems : UserControl
    {
        ...
        private void SetColor()
        {
            ...
            this.ForeColor = Storage.colorItemBackgrund[Storage.themePointer];
            TextField.BackColor = Storage.colorItemBackgrund[Storage.themePointer];
            TextField.ForeColor = Storage.colorText[Storage.themePointer];
            oderField.BackColor = Storage.colorBackgrund[Storage.themePointer];
            oderField.ForeColor = Storage.colorText[Storage.themePointer];

            contextMenuStrip1.ForeColor = Storage.colorText[Storage.themePointer];
        ...
        private void pictureBox_Border_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.Clear(Storage.colorText[Storage.themePointer]);  // Paint the whole PictureBox in the background color
        }

        private void order_Backgrund_Paint(object sender, PaintEventArgs e)
        {
            Graphics g = e.Graphics;
            g.Clear(Storage.colorItemBackgrund[Storage.themePointer]);  // Paint the whole PictureBox in the background color
        }
        ...
        private class MyColors : ProfessionalColorTable
        {
            ...
            {
                get { return Storage.colorBackgrund[Storage.themePointer]; }
            }
            public override Color MenuItemSelectedGradientBegin
            {
                get { return Storage.colorItemBackgrund[Storage.themePointer]; }
            }
