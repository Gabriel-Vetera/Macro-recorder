...
namespace Vetera_MouseRec
{
    public partial class Rec : Form
    {
        ...
        public Rec()
        {
            ...
            rec_spinner.BackColor = Cash.color_backgrund[Cash.theame];

            rec_text_count.BackColor = Cash.color_backgrund[Cash.theame];
            rec_text_count.ForeColor = Cash.color_text[Cash.theame];
