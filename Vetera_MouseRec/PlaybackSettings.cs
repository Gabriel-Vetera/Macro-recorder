...
namespace Vetera_MouseRec
{
    public partial class PlaybackSettings : MetroForm
    {
        ...
        private void SetColor()
        {
            ...
            toolTipMessage.BackColor = Storage.colorItemBackgrund[Storage.themePointer];
            toolTipMessage.ForeColor = Storage.colorText[Storage.themePointer];

            playbackSettings_button_save.BackColor = Storage.colorButton[Storage.themePointer];
            playbackSettings_button_save.ForeColor = Storage.colorText[Storage.themePointer];

            customTextBox1.BackColor = Storage.colorBackgrund[Storage.themePointer];
            customTextBox1.TextColor = Storage.colorText[Storage.themePointer];

            customTextBox2.BackColor = Storage.colorBackgrund[Storage.themePointer];
            customTextBox2.TextColor = Storage.colorText[Storage.themePointer];

            customTextBox3.BackColor = Storage.colorBackgrund[Storage.themePointer];
            customTextBox3.TextColor = Storage.colorText[Storage.themePointer];

            timeVar_min.BackColor = Storage.colorItemBackgrund[Storage.themePointer];
            timeVar_min.ForeColor = Storage.colorText[Storage.themePointer];

            timeVar_max.BackColor = Storage.colorItemBackgrund[Storage.themePointer];
            timeVar_max.ForeColor = Storage.colorText[Storage.themePointer];

            pixelVar_max.BackColor = Storage.colorItemBackgrund[Storage.themePointer];
            pixelVar_max.ForeColor = Storage.colorText[Storage.themePointer];

            pixelVar_min.BackColor = Storage.colorItemBackgrund[Storage.themePointer];
            pixelVar_min.ForeColor = Storage.colorText[Storage.themePointer];
            ...
            randomNumber.BackColor = Storage.colorItemBackgrund[Storage.themePointer];
            randomNumber.ForeColor = Storage.colorText[Storage.themePointer];

            comboBox_PlaybackMode.BackColor = Storage.colorBackgrund[Storage.themePointer];
            comboBox_PlaybackMode.ForeColor = Storage.colorText[Storage.themePointer];
